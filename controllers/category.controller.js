...
exports.editCategory = catchAsyncUtils(async (req, res) => {
  ...
  res.status(200).json({message:'category data editted successfully',data:category})
});
...
exports.changeDeleteFlagCategory = catchAsyncUtils(async (req, res) => {
  ...
  res
    .status(200)
    .json({ message: "category flag is changed successfully", data: category });
});
