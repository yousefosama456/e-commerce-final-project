...
const {addSubCategory,changeDeleteFlagSubCategory,getSubCategory,getSubCategoryAdmin,editSubCategory,getSubCategoriesClient}= require('../controllers/sub-categoy.controller')


router.post('/addsubcategory',authenticate,authorize('admin'),addSubCategory)
router.get('/',getSubCategory)
router.get('/:id/getsubcategoriesclient',getSubCategoriesClient)
